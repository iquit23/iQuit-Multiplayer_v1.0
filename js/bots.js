...
(function (root, factory) {
  ...
  function decidePending(state, p, pend) {
    switch (pend.type) {
      ...
      // v1.21: τα bots δεν φτάνουν πλέον εδώ (ο engine πληρώνει τον φόρο τους αυτόματα)·
      // το κρατάμε για ΑΠΟΣΥΝΔΕΔΕΜΕΝΟΥΣ ανθρώπους που παίζονται αυτόματα από τον host.
      case 'tax-pay': return { a: 'resolve', choice: 'pay' };
      case 'savings': {
