...
(function (root, factory) {
  ...
  const D = {
    el: {
      ...
      loanHint: 'Έως όσο η αξία των επενδύσεών σου ({v}) − υπάρχον χρέος κεφαλαίου · πολλαπλάσια του 100€ · 20 δόσεις × 10% · εξόφληση υποχρεωτική πριν το I QUIT',
      ...
      inflTitle: 'ΠΛΗΘΩΡΙΣΜΟΣ', inflBody: 'Τα μηνιαία έξοδα όλων των παικτών αυξήθηκαν κατά 5%, όπως και όλες οι κάρτες Lifestyle & Moments.',
      ...
      lg_inflation: '📈 Πληθωρισμός 5%: τα μηνιαία έξοδα όλων των παικτών αυξήθηκαν κατά 5%, όπως και όλες οι κάρτες Lifestyle & Moments.',
    ...
    en: {
      ...
      loanHint: 'Up to the value of your investments ({v}) − existing principal debt · multiples of €100 · 20 payments × 10% · must be fully repaid before I QUIT',
      ...
      inflTitle: 'INFLATION', inflBody: 'Everyone’s monthly expenses increased by 5%, and so did all Lifestyle & Moments cards.',
      ...
      lg_inflation: '📈 Inflation 5%: everyone’s monthly expenses rose by 5%, and so did all Lifestyle & Moments cards.',
