...
(function (root, factory) {
  ...
  const D = {
    el: {
      ...
      savExplain: 'Βάλε χρήματα στην άκρη (πολλαπλάσια του 50€). Είναι <b>κλειδωμένα</b>: χρησιμοποιούνται ΜΟΝΟ όταν σε χτυπήσει αρνητική κάρτα Moment — και τότε, αν η αποταμίευση καλύπτει ΟΛΟ το ποσό, πληρώνεις μόνο το 70% (<b>−30% επιβράβευση πρόνοιας</b>) χωρίς να αγγίξεις τα μετρητά σου. Αν δεν φτάνει, πληρώνεις κανονικά από τα μετρητά. Νέα κατάθεση κάθε 5 χρόνια · ανάληψη ΜΟΝΟ στα 60.',
      ...
      lg_savWithdraw: '💶 {n}: ανάληψη όλης της αποταμίευσης στα 60 (+{a})',
      ...
      crashLostBody: 'Η επένδυση χάθηκε λόγω κακής αξιολόγησης ρίσκου — το Crash χτυπά πάντα το χρώμα σου με τη μεγαλύτερη απόδοση. Οι υψηλές αποδόσεις κουβαλούν υψηλό ρίσκο!',
      ffailLostBody: 'Η χρηματοδότηση με τη μεγαλύτερη απόδοση κατέρρευσε. Μην στηρίζεις το πλάνο σου σε μία μόνο πηγή εισοδήματος!',
      ...
      // Cards & modals
      cost: 'Κόστος:', perCycle: '/ κύκλο', permanent: '/ κύκλο (μόνιμα)', each: ' — έκαστος',
      ...
      lg_start: '🎲 Το παιχνίδι ξεκίνησε! Η κλήρωση έδειξε: πρώτος παίζει ο {n}.',
      ...
      lg_career: '🎖️ Career Bonus! Ο {n} έκλεισε τα {age} → μισθός +500€ (νέος: {s})',
      ...
      lg_iquit: '🎉 I QUIT! Ο {n} παραιτήθηκε στα {age} (παθητικό {pas} ≥ έξοδα {exp}, χωρίς χρέη)',
      ...
      lg_bankrupt: '💥 ΧΡΕΟΚΟΠΙΑ! Ο {n} έμεινε με {v} και τίποτα να πουλήσει — εκτός παιχνιδιού.',
      ...
      lg_taxNone: '🧾 Tax: ο {n} δεν έχει εισόδημα από Big Business.',
      lg_crashMiss: '💥 Crash ({colors}): ο {n} δεν έχει Project σε αυτά τα χρώματα — τη γλίτωσε!',
      lg_crashHit: '💥 Crash! Ο {n} χάνει: {title} ({v}, −{inc}/κύκλο)',
      lg_ffMiss: '💥 Funding Fails: ο {n} δεν έχει Χρηματοδοτήσεις — τη γλίτωσε!',
      lg_ffHit: '💥 Funding Fails! Ο {n} χάνει: {title} ({v})',
      ...
      lg_buyBB: '🏆 {n} αγόρασε Big Business: «{title}» {v} → +{inc}/κύκλο',
      lg_buyBBDisc: '🏆 {n} αγόρασε Big Business: «{title}» {v} (έκπτωση -10%) → +{inc}/κύκλο',
      lg_buyP: '📊 {n} αγόρασε Project {colors}: «{title}» {v} → +{inc}/κύκλο',
      lg_buyF: '🤝 {n} αγόρασε Χρηματοδότηση: «{title}» {v} → +{inc}/κύκλο',
      lg_buyBond: '🏛️ {n} αγόρασε Κρατικό Ομόλογο {v} (4%/είσπραξη, λήξη στα 10 tokens)',
      lg_masters: '🎓 {n} έκανε Μεταπτυχιακό ({v}) → μισθός +{up} (νέος: {s})',
      lg_taxprepay: '🧾 {n} πλήρωσε Προκαταβολή Φόρου ({v}) → Φόροι −{d}/κύκλο',
      ...
      lg_offer: '🤝 {n} προσφέρει τη Χρηματοδότηση «{title}» στον {n2} για {v}',
      ...
      lg_passDisc: '➡️ Ο {n} δεν αγόρασε «{title}» — ο {n2} μπορεί να την πάρει με -10% ({v})',
      lg_declined: '✋ {n} δεν αγόρασε: «{title}»',
      lg_forcedSold: '🔻 Αναγκαστική πώληση: {n} — «{title}» → +{v}',
      lg_offerAccepted: '🤝 Ο {n} αγόρασε τη «{title}» από τον {n2} για {v}',
      lg_offerDeclined: '✋ Ο {n} αρνήθηκε την προσφορά Χρηματοδότησης.',
    },
    en: {
      ...
      lg_savWithdraw: '💶 {n}: withdrew all savings at 60 (+{a})',
      ...
      crashLostBody: 'The investment was lost to poor risk assessment — a Crash always hits your color with the highest yield. High returns carry high risk!',
      ffailLostBody: 'Your highest-yield funding collapsed. Never rely on a single source of income!',
      ...
      cost: 'Cost:', perCycle: '/ cycle', permanent: '/ cycle (permanent)', each: ' — each',
      ...
      lg_crashHit: '💥 Crash! {n} loses: {title} ({v}, −{inc}/cycle)',
      ...
      lg_buyBB: '🏆 {n} bought Big Business: “{title}” {v} → +{inc}/cycle',
      lg_buyBBDisc: '🏆 {n} bought Big Business: “{title}” {v} (10% off) → +{inc}/cycle',
      lg_buyP: '📊 {n} bought a {colors} Project: “{title}” {v} → +{inc}/cycle',
      lg_buyF: '🤝 {n} bought Funding: “{title}” {v} → +{inc}/cycle',
      lg_buyBond: '🏛️ {n} bought a Government Bond {v} (4%/payday, matures at 10 tokens)',
      lg_masters: '🎓 {n} earned a Master’s ({v}) → salary +{up} (now {s})',
      lg_taxprepay: '🧾 {n} paid a Tax Prepayment ({v}) → Taxes −{d}/cycle',
