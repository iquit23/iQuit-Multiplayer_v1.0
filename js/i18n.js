...
(function (root, factory) {
  ...
  const D = {
    el: {
      ...
      hintT_betterloan: '🏦 Ευνοϊκότερο Δάνειο', hintB_betterloan: 'Καλύτεροι όροι δανεισμού: −2 δόσεις στο μεγαλύτερο ενεργό δάνειό σου (ή στο επόμενο που θα πάρεις).',
    ...
    en: {
      ...
      hintT_betterloan: '🏦 Better Loan Terms', hintB_betterloan: 'Better borrowing terms: −2 installments on your largest active loan (or your next one).',
