...
(function (root, factory) {
  ...
  const D = {
    el: {
      ...
      loanCap: '🔒 Έφτασες το όριο των {n} ενεργών δανείων — εξόφλησε κάποιο για να δανειστείς ξανά.',
    ...
    en: {
      ...
      loanCap: '🔒 You reached the limit of {n} active loans — repay one to borrow again.',
