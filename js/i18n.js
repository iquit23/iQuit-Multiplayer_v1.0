...
(function (root, factory) {
  ...
  const D = {
    el: {
      ...
      portfolio: 'Χαρτοφυλάκιο', totalInv: 'Σύνολο επενδύσεων', noInv: 'Δεν έχεις επενδύσεις ακόμα.',
    ...
    en: {
      ...
      portfolio: 'Portfolio', totalInv: 'Total investments', noInv: 'No investments yet.',
