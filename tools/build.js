...
html = html.replace('<link rel="stylesheet" href="css/style.css?v=2.3">', () => '<style>\n' + css + '\n</style>');

for (const f of ['cards.js', 'i18n.js', 'scoring.js', 'leaderboard.js', 'engine.js', 'bots.js', 'net.js', 'net-fb.js', 'transport.js', 'account.js', 'ui.js']) {
  const js = fs.readFileSync(path.join(root, 'js', f), 'utf8');
  html = html.replace('<script src="js/' + f + '?v=2.3"></script>', () => '<script>\n' + js + '\n</script>');
}
